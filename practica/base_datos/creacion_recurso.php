<?php
        ...
        $db=mysqli_select_db($link,"75932436y") or die ("<h2>Error de conexion</h2>");
            ...
            if ($result->num_rows > 0) {
              ...
              mysqli_query($link,"CREATE TABLE $id(nombre varchar(30), dni varchar(9), codigo varchar(4), OrderDate datetime NOT NULL DEFAULT NOW(), pos int, estado varchar(2))") or die ("<h2>Error......</h2>");
